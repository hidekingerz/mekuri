...
- FR-M7: アーカイブファイルまたは PDF をダブルクリックするとビューワーウィンドウを開く（シングルクリックは選択）
...
- FR-M13: ファイルリストはクリックで選択（範囲選択の起点）、Cmd/Ctrl+クリックでトグル、Shift+クリックで範囲選択ができ、コンテキストメニューまたは Delete キーで選択したファイルをまとめてゴミ箱へ移動できる（確認ダイアログは 1 回）。Esc で選択解除
