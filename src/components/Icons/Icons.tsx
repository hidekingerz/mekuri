  ...
  return (
    ...
    >
      <path
        ...
        style={{ fill: "var(--icon-folder-fill)", stroke: "var(--icon-folder-stroke)" }}
        strokeWidth="1"
      />
    </svg>
  );
...
export function FolderOpenIcon({ size = 16, className }: IconProps) {
  return (
    ...
    >
      ...
      />
      <path
        d="M2.5 6.5H14L12.5 12.5H1L2.5 6.5Z"
        style={{ fill: "var(--icon-folder-fill-light)", stroke: "var(--icon-folder-stroke)" }}
        strokeWidth="1"
      />
    </svg>
  );
  ...
  return (
    ...
    >
      <rect
        ...
        height="10"
        rx="1"
        style={{ fill: "var(--icon-archive-fill)", stroke: "var(--icon-archive-fill-accent)" }}
        strokeWidth="1"
      />
      <rect
        x="6"
        ...
        height="2"
        rx="0.5"
        style={{ fill: "var(--icon-archive-fill-accent)" }}
      />
      <path
        d="M6 8H10V10C10 10.5523 9.55228 11 9 11H7C6.44772 11 6 10.5523 6 10V8Z"
        style={{ fill: "var(--icon-archive-fill-light)" }}
      />
    </svg>
  );
}
